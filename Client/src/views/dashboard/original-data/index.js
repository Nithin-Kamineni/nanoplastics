...
const ProductList = () => {
    ...
    const handleSearch = (event) => {
        ...
        if (newString) {
            const newRows = rows.filter((row) => {
                ...
                const properties = ['CitationNumber', 'Drug', 'Analyte', 'CAS', 'Species', 'LambdaZHl'];
    ...
    return (
        <MainCard title="Original Data" content={false}>
            <CardContent>
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} sx={{ textAlign: 'right' }}>
                        <CSVExport data={rows} filename="OriginalDataFile.csv" header={headCells} />
                    </Grid>
                </Grid>
            </CardContent>
                            ...
                            .map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="center">{row.Analyte}</TableCell>
                                        <TableCell align="center">{row.CAS}</TableCell>
                                        <TableCell align="center">{row.Species}</TableCell>
                                        <TableCell align="center">{row.LambdaZHl}</TableCell>
