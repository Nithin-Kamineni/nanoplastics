...
# setwd(file.path(script_dir, "input data"))
setwd("C:/profitional/nanoplastics/R-server/Web interface/input data")
...
# Keinänen et al. (2021)   : Single dose at 0.1 mg, 220 nm, matrix: Spleen, Kidney, Urine, Blood, Liver, Lung, GI (Unit: mg/kg) 
##################################################################################################################################

## Input data set for model calibration/ oral
# setwd("//file.phhp.ufl.edu/data/home/chen.chiyun/Documents/UF Course/PBPK Modeling in Toxicology_PHC7738C/Class Project/Input data R")
...
pred <- function(pars) {
  ...
  Concen.K      = 5      # Exposure concentration, mg/kg
